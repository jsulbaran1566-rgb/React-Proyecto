  ...
  return (
    <section className="ad-panel">
      ...
      <p className="ad-panel__descripcion">
        Consulta y listado detallado de los usuarios registrados en la plataforma.
      </p>
      ...
      <div className="ad-cards-accion">
        <CardAccion
          ...
          descripcion="Registrar un nuevo usuario en la base de datos."
          textoBoton="Agregar"
          onEjecutar={manejarAccionUsuarios}
        />
        <CardAccion
          titulo="Exportar listado"
          descripcion="Descargar la lista de usuarios en formato CSV."
          textoBoton="Exportar"
          onEjecutar={manejarAccionUsuarios}
        />
      </div>
